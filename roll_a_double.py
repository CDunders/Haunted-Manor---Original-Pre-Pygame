...
class Users:
    ...
    def greeting(self):
        """Greeting intro to game with rules"""
    ...
    def play_round(self):
        ...
        # Determine and display winnner based on total scores
    ...
    def display_results(self):
        """Display results of last round and current scores"""
        ...
        sleep(2)
        # Display current score and game leader
    ...
    def dice_roll_player_1(self):
        """Simulate rolling dice for player one and update their score"""
    ...
    def dice_roll_player_2(self):
        """Simulate rolling dice for player two and update their score"""
        dice_1 = rand.randint(1,6)
        dice_2 = rand.randint(1,6)
